...
ambagsRouter.get("/", async (_, res: Response) => {
  try {
...
ambagsRouter.get("/:id", async (req: Request, res: Response) => {
  try {
...
ambagsRouter.post("/", async (req: Request, res: Response) => {
  try {
...
ambagsRouter.patch("/:id", async (req: Request, res: Response) => {
  try {
...
ambagsRouter.delete("/:id", async (req: Request, res: Response) => {
  try {
    await validateDocument(req.params.id, Collection.AMBAGS, res);
    await admin
      .firestore()
